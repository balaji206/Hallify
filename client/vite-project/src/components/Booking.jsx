...
function Booking() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (token) {
                    const userRes = await axios.get("https://hallify.onrender.com/api/users/get", {
                ...
                // Fetch Mahal details
                const mahalRes = await axios.get(`https://hallify.onrender.com/api/mahal/get/${id}`);
                ...
                const bookingsRes = await axios.get(`https://hallify.onrender.com/api/booking/mahal/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://hallify.onrender.com/api/booking/create", {
                mahalId: id,
